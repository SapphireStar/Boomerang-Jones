...
public class SpiderEnemySlowTraceState : State
{
    private float speed;
    ...
    public override void onEnter(StateMachine _stateMachine)
    {
        ...
        /// </summary>
        speed = DataManager.Instance.Enemies[2].Speed * Game.Instance.Difficulty *0.5f;
    ...
    void checkIsInSlowZone()
    {
        ...
        else
        {
            ...
            if (hit == null)
            {
                stateMachine.SetNextState(new SpiderEnemyTraceState());
            }
        }
